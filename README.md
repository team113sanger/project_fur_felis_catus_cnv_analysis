...
```bash
# If using poetry
PROJECT_URL="https://gitlab.internal.sanger.ac.uk/api/v4/projects/5544/packages/pypi/simple"
poetry source add --priority=supplemental gitlab-pypi $PROJECT_URL
poetry add fur_cnvkit --source gitlab-pypi

# If using pip
PROJECT_URL="https://gitlab.internal.sanger.ac.uk/api/v4/projects/5544/packages/pypi/simple"
pip install fur_cnvkit --index-url $PROJECT_URL
...
poetry add fur_cnvkit --source gitlab-pypi-grp
```
...
Once the `fur_cnvkit` package is installed, it provides two command-line scripts: `add` and `multiply`. These scripts can be called directly from the command line.
